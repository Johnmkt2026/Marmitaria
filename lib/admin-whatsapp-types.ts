...
export type WhatsAppMessage = {
  ...
  message_type: string; content_text: string | null; template_name: string | null; status: WhatsAppMessageStatus;
...
export type WhatsAppCenterData = { conversations: WhatsAppConversation[]; fallback_orders: WhatsAppOrder[]; integration_enabled: boolean; automations_enabled: boolean; restaurant_name: string; delivery_minutes_min: number | null; delivery_minutes_max: number | null };
